...
import dono.daryo.enums.Status;
import dono.daryo.model.*;
import dono.daryo.repository.*;
...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1 = new Customer("msmith","Mike","Smith","msmith@daryo.com","VA");
